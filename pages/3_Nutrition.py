...
with engine.connect() as conn:
    dish_statement = sqlalchemy.text("SELECT * FROM Dish")
    all_dish_results = conn.execute(dish_statement).fetchall()
dish_keywords = ['',]
...
if dish_keyword != '':
    with engine.connect() as conn:
        dish_statement =sqlalchemy.text("SELECT * FROM Dish WHERE Name = :name")
        dish_result = conn.execute(dish_statement, {'name': dish_keyword}).fetchone()
